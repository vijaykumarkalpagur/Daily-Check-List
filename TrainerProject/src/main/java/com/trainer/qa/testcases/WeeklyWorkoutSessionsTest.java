...
@Test (priority = 2)
public void WeeklySession() throws Exception{
	WeeklySessionAction.WeeklySession(Browserhelper.driver);
	Log.info("Successfully created Weekly Workout Session with valid inputs");}
